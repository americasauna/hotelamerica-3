...
<body>
	...
	<tr>
		...
		<td id="des">
			<h3><a href="/servicios/hospedaje">Hospedaje</a></h3><br><h4 class="des">Sienta la comodidad de un cálido hogar.<br>Contamos con diferentes tipos de habitaciones adaptables a sus ncesidades.</h4>
		</td>
	</tr>
	<tr>
