...
<br>
<center><div class="re">
<center><h1>DISFRUTA DE NUESTRO SERVICIOS<br> realiza tus reservaciones aqui </h1></center>

<br>
<br>
<br>
<center><table><tr><td>
<form action="/reservacion/hotel" method="POST">
<input type="hidden" value="hotel1" name="hotel1">
<input  class="rese" type="submit" value="HOTEL">
</form>
</td>
<td>
<form method="POST"action="/reservacion/spa">
<input type="hidden" value="spa2" name="spa2">
<input class="rese" type="submit" value="SPA">
</form>
</td>
</tr>
</table></center>
