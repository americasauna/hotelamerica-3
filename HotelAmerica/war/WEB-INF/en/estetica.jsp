...
<%menu.setAttribute("index", "estetica");%>
...
<body>
	...
	<div>
		...
		<div id="sugerir">
		<form action="/servicios/estetica" method="post" name="formuIdiomas">	
	...
	<div>
	<h1 id="titulo">Esthetic</h1>
	
	<p>Sauna & Spa Hotel AMERICA offers services esteica:</p>
	<br><hr>
	</div>
	<br>	
	<center>
	<div id="conteiner">
		<div class="sec">
			<center><h3>hair</h3>
			<br>
			<h4> Professional treatments for hair provide specialized care that may take some time. Usually a little more expensive than homemade, but worth pena.Algunos deberÃas professional treatments that try are: </h4>
		...
		<div class="sec">
			...
			<br>
			<h4> During a normal day, the feet support several kilos of weight. Also, have healthy feet, treated feet is vital to enjoy good health in general. Clean foot, giving special attention to the AU and a revitalizing massage is applied. A good pedicure can be very relaxing, and if there are health problems, very therapeutic. </h4>
		...
		<div class="sec">
			...
			<br>
			<h4> The manicure helps to keep in perfect condition the fingernails ± as and beautify hands and thus complement the overall look of each person. </h4>
		...
		<div class="sec">
			<center><h3>dyes</h3>
			<br>
			<h4> combines the color of your hair with your style of clothing. With our quality products imported from the best producers of dyes countries worldwide. </h4>
