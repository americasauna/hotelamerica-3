...
<%menu.setAttribute("index", "masajes");%>
...
<body>
	...
	<div>
		...
		<table id="tablaM">
		<tr>
			<td><h2 class="titu">massage Therapy</h2><br>
	The relaxing massage is an alternative to experience <br>
a state of peace deal with the pressures of daily life <br>
and it is a powerful anti-stress tool that gives full <br>
physical and emotional calm and comfortable rest to the patient, <br>
in addition to its known effects for circulation</td>
			<td>
	...
	<!-- End WOWSlider.com BODY section --></td>
		...
		<tr>
		<td><h2 class="titu">massage Descontracturantes</h2>
		<br>A muscle spasm is a contraction <br>
              persistent and involuntary muscle. a <br>
muscle contracts and relaxes, but <br>
some cases, a vast area of muscle not <br>
relaxing and still contracted.
		</td>
		<td>
	<!-- Start WOWSlider.com BODY section --> <!-- add to the <body> of your page -->
	...
	<!-- End WOWSlider.com BODY section --><!-- End WOWSlider.com BODY section --></td>
		...
		<tr>
		<td>
		<h2 class="titu"> HOT STONE MASSAGE</h2>
          You can choose from a relaxing massage or relieving <br>
and adding a massage with hot stones. This is our <br>
premium service. The hot stone massage combines <br>
Traditional therapeutic massage with the application of stones <br>
hot on the skin.
