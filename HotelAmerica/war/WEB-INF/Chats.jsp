...
<%@page import="javax.jdo.PersistenceManager"%>
    ...
    Query q = pm.newQuery(Chat.class);
    q.setOrdering("key descending");
    List<Chat> chats = (List<Chat>)q.execute();
    %>
...
<%for(Chat c: chats){%>
<tr>
<td><%=c.getUser()+" dice:" %></td><td><%=c.getMensaje()%></td>
</tr>
<%} %>
</table>
<br><br>
<form action="/guardarChat?name=<%=name %>" method="post">
<input type="text" name="msj"><input type="hidden" value="<%=name%>" name="name">
